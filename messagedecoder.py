...
tbLIST_NOCAPS = ['the', 'possums', 'hate', 'the', 'possums', 'so', 'much', 'rage', 'for', 'them', 'is', 'all', 'can', 'think', 'about', 'They', 'scratch', 'and', 'bite', 'like', 'the', 'demons', 'in', 'fairy', 'tales', 'can', 'no', 'longer', 'love', 'you', 'can', 'only', 'hate', 'the', 'possums'] #not in UI
tbLIST_NOCAN = ['Dearest', 'Rebecca', 'I', 'Hate', 'the', 'possums', 'I', 'hate', 'the', 'possums', 'so', 'much', 'My', 'rage', 'for', 'them', 'is', 'all', 'I', 'think', 'about', 'They', 'scratch', 'and', 'bite', 'like', 'the', 'demons', 'in', 'fairy', 'tales', 'I', 'no', 'longer', 'love', 'you', 'I', 'only', 'hate', 'the', 'possums', 'Sincerely', 'Timothy', 'Bonner'] #not in UI
tbLIST_NOINOPOSSUMS = ['Dearest', 'Rebecca', 'Hate', 'the', 'hate', 'the', 'so', 'much', 'My', 'rage', 'for', 'them', 'is', 'all', 'can', 'think', 'about', 'They', 'scratch', 'and', 'bite', 'like', 'the', 'demons', 'in', 'fairy', 'tales', 'can', 'no', 'longer', 'love', 'you', 'can', 'only', 'hate', 'the', 'Sincerely', 'Timothy', 'Bonner'] #not in UI
tbLIST_NOINOPOSSUMSNOCANONEHATE = ['Dearest', 'Rebecca', 'Hate', 'the', 'the', 'so', 'much', 'My', 'rage', 'for', 'them', 'is', 'all', 'think', 'about', 'They', 'scratch', 'and', 'bite', 'like', 'the', 'demons', 'in', 'fairy', 'tales', 'no', 'longer', 'love', 'you', 'only', 'the', 'Sincerely', 'Timothy', 'Bonner'] #not in UI
...
text = tbLIST_NOINOPOSSUMSNOHATE
length = len(text)
sliced = []
